...
--
-- Hôte : localhost:3306
-- Généré le : dim. 29 mars 2026 à 20:56
...
INSERT INTO `studios` (`id_studio`, `owner_user_id`, `name`, `description`, `location`, `website`, `createdAt`, `updatedAt`) VALUES
(1, 3, 'Zen Studio', 'Studio calme', 'Bordeaux', NULL, '2026-03-23 15:08:37', NULL),
(2, 4, 'Flow Studio', 'Studio dynamique', 'Paris', NULL, '2026-03-23 15:08:37', NULL);
...
INSERT INTO `users` (`id_user`, `email`, `password`, `userType`, `createdAt`) VALUES
(1, 'teacher1@mail.com', 'password', 'teacher', '2026-03-23 15:08:36'),
(2, 'teacher2@mail.com', 'password', 'teacher', '2026-03-23 15:08:36'),
(3, 'studio1@mail.com', 'password', 'studio', '2026-03-23 15:08:36'),
(4, 'studio2@mail.com', 'password', 'studio', '2026-03-23 15:08:36');
